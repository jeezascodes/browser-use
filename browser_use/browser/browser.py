...
class BrowserConfig:
    ...
    Default values:
        ...
        use_physical_input: False
            Whether to use physical mouse/keyboard input for interactions

        physical_input_actions: {'click_element', 'input_text', 'scroll_down', 'scroll_up', 'send_keys'}
            Set of action names that should use physical input when enabled
    """
    ...
    use_physical_input: bool = True
    physical_input_actions: set[str] = field(
